...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%20default%20%3E%20(param)%20zone_id%20%3E%20(schema)>)

waiting\_room\_id: string

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%20default%20%3E%20(param)%20waiting_room_id%20%3E%20(schema)>)

event\_id: string

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%20default%20%3E%20(param)%20event_id%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20event_end_time%20%3E%20(schema)>)

event\_start\_time: string

An ISO 8601 timestamp that marks the start of the event. At this time, queued users will be processed with the event’s configuration. The start time must be at least one minute before `event_end_time`.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20event_start_time%20%3E%20(schema)>)

name: string

A unique name to identify the event. Only alphanumeric characters, hyphens and underscores are allowed.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20name%20%3E%20(schema)>)

custom\_page\_html: optional string

If set, the event will override the waiting room’s `custom_page_html` property while it is active. If null, the event will inherit it.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20custom_page_html%20%3E%20(schema)>)

description: optional string

A note that you can use to add more details about the event.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20description%20%3E%20(schema)>)

disable\_session\_renewal: optional boolean

If set, the event will override the waiting room’s `disable_session_renewal` property while it is active. If null, the event will inherit it.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20disable_session_renewal%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20new_users_per_minute%20%3E%20(schema)>)

prequeue\_start\_time: optional string

An ISO 8601 timestamp that marks when to begin queueing all users before the event starts. The prequeue must start at least five minutes before `event_start_time`.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20prequeue_start_time%20%3E%20(schema)>)

queueing\_method: optional string

If set, the event will override the waiting room’s `queueing_method` property while it is active. If null, the event will inherit it.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20queueing_method%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20session_duration%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20shuffle_at_event_start%20%3E%20(schema)>)

suspended: optional boolean

Suspends or allows an event. If set to `true`, the event is ignored and traffic will be handled based on the waiting room configuration.

[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20suspended%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20total_active_users%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20turnstile_action%20%3E%20(schema)>)
...
[Link to this property](#)%20waiting_rooms.events%20%3E%20(method)%20edit%20%3E%20(params)%200%20%3E%20(param)%20turnstile_mode%20%3E%20(schema)>)
