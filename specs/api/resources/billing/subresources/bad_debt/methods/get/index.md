...
[Bad Debt](https://developers.cloudflare.com/api/resources/billing/subresources/bad_debt)
...
[Link to this property](#)%20billing.bad_debt%20%3E%20(method)%20get%20%3E%20(params)%20default%20%3E%20(param)%20account_id%20%3E%20(schema)>)
...
[Link to this property](#)%20billing.bad_debt%20%3E%20(method)%20get%20%3E%20(network%20schema)%20%3E%20(property)%20errors>)
...
[Link to this property](#)%20billing.bad_debt%20%3E%20(method)%20get%20%3E%20(network%20schema)%20%3E%20(property)%20messages>)

<details>

<summary>

result: object {already\_paid, bad\_debt\_status, invoices, total\_debt\_amount }
...
[Link to this property](#)%20billing.bad_debt%20%3E%20(method)%20get%20%3E%20(network%20schema)%20%3E%20(property)%20result>)

success: true

Whether the API call was successful

[Link to this property](#)%20billing.bad_debt%20%3E%20(method)%20get%20%3E%20(network%20schema)%20%3E%20(property)%20success>)
...
```
curl https://api.cloudflare.com/client/v4/accounts/$ACCOUNT_ID/billing/bad-debt \
