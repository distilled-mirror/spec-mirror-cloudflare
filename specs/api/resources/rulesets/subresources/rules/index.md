...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20block_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20compress_response_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20ddos_dynamic_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20execute_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20force_connection_close_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20log_custom_field_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20log_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20logging%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20managed_challenge_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20redirect_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20rewrite_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20route_rule%20%3E%20(schema)>)

<details>

<summary>

RulesetRule object {last\_updated, version, id, 10 more }
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20ruleset_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20score_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20serve_error_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20set_cache_settings_rule%20%3E%20(schema)>)
...
action\_parameters: optional object {automatic\_https\_rewrites, autominify, bic, 21 more }
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20set_config_rule%20%3E%20(schema)>)
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20skip_rule%20%3E%20(schema)>)

<details>

<summary>

RuleCreateResponse = object {id, kind, last\_updated, 5 more } or unknown
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20rule_create_response%20%3E%20(schema)>)

<details>

<summary>

RuleEditResponse = object {id, kind, last\_updated, 5 more } or unknown
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20rule_edit_response%20%3E%20(schema)>)

<details>

<summary>

RuleDeleteResponse = object {id, kind, last\_updated, 5 more } or unknown
...
[Link to this property](#)%20rulesets.rules%20%3E%20(model)%20rule_delete_response%20%3E%20(schema)>)