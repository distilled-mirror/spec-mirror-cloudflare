---
title: Get HTTP authentication requests by compromised credential status time series
---
...
[Timeseries Groups](https://developers.cloudflare.com/api/resources/radar/subresources/leaked_credentials/subresources/timeseries_groups)
...
Deprecated: Use \[Radar Leaked Credentials Timeseries Groups By Dimension](https://developers.cloudflare.com/api/resources/radar/subresources/leaked\_credentials/methods/timeseries\_groups\_v2/) instead.
...
[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20aggInterval%20%3E%20(schema)>)
...
[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20botClass%20%3E%20(schema)>)

dateEnd: optional array of string

End of the date range (inclusive). Alternative to `dateRange`; provide together with `dateStart`. When requesting comparison series, every series must resolve to the same duration as the main series. Each `dateStart`/`dateEnd` is floored to the nearest 15 minutes before evaluation, so windows whose durations match only before alignment may be rejected.

[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20dateEnd%20%3E%20(schema)>)
...
[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20dateRange%20%3E%20(schema)>)

dateStart: optional array of string

Start of the date range. Alternative to `dateRange`; provide together with `dateEnd`. When requesting comparison series, every series must resolve to the same duration as the main series. Each `dateStart`/`dateEnd` is floored to the nearest 15 minutes before evaluation, so windows whose durations match only before alignment may be rejected.

[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20dateStart%20%3E%20(schema)>)
...
[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20format%20%3E%20(schema)>)

name: optional array of string

Array of names used to label the series in the response.

[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(params)%20default%20%3E%20(param)%20name%20%3E%20(schema)>)
...
[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(network%20schema)%20%3E%20(property)%20result>)

success: boolean

[Link to this property](#)%20radar.leaked_credentials.timeseries_groups%20%3E%20(method)%20compromised%20%3E%20(network%20schema)%20%3E%20(property)%20success>)
