...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%20default%20%3E%20(param)%20account_id%20%3E%20(schema)>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%20default%20%3E%20(param)%20trigger_uuid%20%3E%20(schema)>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20branch_excludes%20%3E%20(schema)>)

branch\_includes: optional array of string

Branch patterns that can start builds.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20branch_includes%20%3E%20(schema)>)

build\_caching\_enabled: optional boolean

Whether builds reuse cached dependencies and build artifacts.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20build_caching_enabled%20%3E%20(schema)>)

build\_command: optional string

Command to build the Worker.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20build_command%20%3E%20(schema)>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20build_token_uuid%20%3E%20(schema)>)

deploy\_command: optional string

Command to deploy the Worker.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20deploy_command%20%3E%20(schema)>)

path\_excludes: optional array of string

Path patterns that must not start builds.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20path_excludes%20%3E%20(schema)>)

path\_includes: optional array of string

Path patterns that can start builds.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20path_includes%20%3E%20(schema)>)

root\_directory: optional string

Repository directory in which build and deploy commands run.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20root_directory%20%3E%20(schema)>)

trigger\_name: optional string

Human-readable name of the build trigger.

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(params)%200%20%3E%20(param)%20trigger_name%20%3E%20(schema)>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(network%20schema)%20%3E%20(property)%20errors>)

messages: array of string

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(network%20schema)%20%3E%20(property)%20messages>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(network%20schema)%20%3E%20(property)%20result>)

success: boolean

[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(network%20schema)%20%3E%20(property)%20success>)
...
[Link to this property](#)%20workers_builds.triggers%20%3E%20(method)%20update%20%3E%20(network%20schema)%20%3E%20(property)%20result_info>)
